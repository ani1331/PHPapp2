...
SET FOREIGN_KEY_CHECKS=1;DROP TABLE IF EXISTS `employees`;
...
SET FOREIGN_KEY_CHECKS=1;DROP TABLE IF EXISTS `offices`;
...
SET FOREIGN_KEY_CHECKS=1;DROP TABLE IF EXISTS `orderdetails`;
...
SET FOREIGN_KEY_CHECKS=1;DROP TABLE IF EXISTS `orders`;
...
SET FOREIGN_KEY_CHECKS=1;DROP TABLE IF EXISTS `payments`;
...
SET FOREIGN_KEY_CHECKS=1;DROP TABLE IF EXISTS `productlines`;
...
SET FOREIGN_KEY_CHECKS=1;DROP TABLE IF EXISTS `products`;
